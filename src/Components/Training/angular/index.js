  ...
  return (
    <div>
        ...
        <div className="container m-auto">
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                ...
                <div className="mt-8 mb-12 text-base">
                  Power your career with great Angular learning and specialize
                  on JavaScript, HTML & MVC Framework
                </div>
            ...
            <Col lg={12} md={12} sm={0} xs={0}>
              <img src={angular} alt="kjhdba" className="animate-bounce" />
            </Col>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          <div className="text-base">
            ...
            Angular certification course in Coimbatore will help you master the
            front-end web development of Angular. Angular is a structural
            framework for dynamic web apps and it lets you use HTML as your
            template language and extend HTML’s syntax to represent your
            application’s components clearly and briefly. It is fully extensible
            and operates well with other libraries. All the features can be
            modified or replaced to befit your unique development workflow and
            essential features.Our Angular Development training in Coimbatore
            fee is very nominal which anyone can pay in installment basis as
            well. We are having multiple class timings which suit everyone who
            wants to learn in their own timing. We do have fast track Angular
            training and online Angular training with one-to-one basis. In case
            you are having queries regarding the time, place and duration of the
            course you can contact our help desk. Learn more about concepts such
            as facilitating the development of single-page web applications,
            dependency injection, typography, components, and directives with
            this Angular Course in Coimbatore.
          </div>
        </div>
            ...
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Learn how to drive a heightened user experience when they
                  access web apps on the browser.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will learn to create single-page applications with one of
                  the most modern JavaScript frameworks out there.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Understanding the separation of Model, View, and Controller of
                  an application and making them use Angular.{" "}
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Get to know core features around Angular such as API wrapping,
                  extending HTML with directives, and using data binding to
                  connect browser-based UI with server app components.
                </div>
              </Col>
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Fully understands the architecture behind an Angular
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  You will learn about the Angular Library, JavaScript and MVC
                  framework.
                </div>
              </Col>
            </Row>
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
            This Angular Certification course in Coimbatore is designed to give
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                  Angular training facilitates a deep understanding of HTML,
                  CSS, and JavaScript and apply them in learning how to build
                  single-page web applications with this popular JavaScript
                  framework. Angular has some core features like Data-binding,
                  Scope, Controller, Services, Filters, Directives, Templates,
                  Routing, Model View, Whatever, Deep Linking and Dependency
                  Injection. Learn the specialized Angular Course with Placement
                  in Coimbatore at the NSCHOOL Academy.
                </div>
                <div className="mt-8">
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
            Why KITKAT Software Technologics for Angular development Training in
            Coimbatore?
          </div>
          <div className="text-base pb-4">
            KITKAT Software Technologics Best Angular Developer Training program
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
            A basic knowledge of front-end development using JavaScript and HTML
      ...
      <div className="section9 bg-[#1b424e] pt-8">
        <div className="container mx-auto md:px-6 xl:px-24">
          <section>
            ...
            <div className="mb-6 pl-6 pr-6 text-base text-white">
              Power your career with great Angular learning and specialize on
              JavaScript, HTML & MVC Framework.
            </div>
