...
const items = [
    ...
    children: (
      <div>
        <ul>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Numpy
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Pandas
          </li>
          <li className="mb-2">
    ...
    children: (
      <div>
        <ul>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Sorting
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Filtering
  ...
  {
    key: "3",
    label: "How Machine Learning is used in Data Science?",
    children: (
      <div>
        <ul></ul>
      </div>
  ...
  {
    key: "4",
    label: "Aggregate Statistics using Sum, Mean, Counting",
    children: (
      <div>
        <ul></ul>
      </div>
  ...
  {
    key: "5",
    label: "Setting Chunk size(Massive Data Handling)",
    children: (
      <div>
        <ul></ul>
      </div>
  ...
  {
    key: "5",
    label: "Clustering & Types",
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> K-means
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
    ...
    children: (
      <div>
        <ul>
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Example
          </li>
        </ul>
      </div>
    ),
...
const items2 = [
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
          You can reach out to us by visiting our website and interact with our
          live chat support team. Our customer service representatives will
          assist you with all your queries. You can also send us an email at
          contact@n-school.com with your query and our Sales Team will clarify
          your queries or call us on +919043494941
        </div>
      </div>
    ),
  },
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
          ...
          high value real-time projects as part of the training programWe
          provide 100% placement assistance and our placement record is 100%
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
          You will receive a Data Science certification in the form of a course
          completion certificate by the end of the training
        </div>
      </div>
    ),
  },
  {
    key: "4",
    label: "Why should I learn this course from KITKAT ACADEMY",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
          KITKAT SOFTWARE TECHNOLOGY is a pioneer in providing IT courses to
          students, Job searchers and working experts. Expert Faculties, Fully
          hands-on training, No PPT based learning, 100% job oriented training,
          Flexible scheduled classes, Ensured interviews, and Affordable cost
          fees are the unique features of KITKAT SOFTWARE TECHNOLOGY that makes
          you to choose us
        </div>
      </div>
    ),
  ...
  return (
    <div>
        ...
        <div className="container m-auto">
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-3xl font-semibold">
                  ...
                  dedicated Data Science Course Training in Coimbatore
                </div>
                <div className="mt-8 mb-12 text-base">
                  Power your career with great Data Science learning and
                  specialize on Python and Data Science functionalities like
            ...
            <Col lg={12} md={12} sm={0} xs={0}>
              <img src={data} alt="kjhdba" className="animate-bounce" />
            </Col>
            <Col lg={0} md={0} sm={24} xs={24}>
              <img src={data} alt="kjhdba" className="mt-10 animate-bounce" />
            </Col>
          </Row>
        </div>
      </div>
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          <div className="text-base ms-4">
            ...
            <span className="font-semibold">
              Data Science Course Training Institute in Coimbatore{" "}
            </span>{" "}
            offers the most progressive certification courses that incorporate
            different segments like Machine Learning, Cluster Analysis, Data
            Mining, Cleansing, Transformation, and Deploying Data Visualization,
            among other things. In the course, the candidates are shown a basic
            arrangement of aptitudes, such as Statistical analysis, Predictive
            Analysis, Big Data Analytics, and more. Since the methodology of the
            course is hands-on rather than hypothetical, the candidates are
            ready for any number of tasks, be it dealing with statistical
            packages. This implies, without a doubt, the future will be
            available to a wide range of career prospects.
          </div>
        </div>
        <div className="container m-auto p-6">
          ...
          <div className="text-base ms-4">
            {" "}
            <span className="font-semibold"></span> Data Science also known as
            data-driven science encourages you to make models, methodologies,
            and calculations that give viable utility. Data science course is
            likewise the act of asking inquiries and discovering answers to
            unknown problems which in turn motivate business esteems. This cycle
            includes working with a lot of existing information or
            characterizing the data all by yourself. These investigations are
            performed by making different tools or calculations sometimes in an
            equal or distributed architecture. You also can turn into a data
            scientist by selecting a good Data Science Course in Coimbatore with
        ...
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
            KEY FEATURES OF DATA SCIENCE COURSE IN COIMBATORE
          </div>
          <div>
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Learn what data science course is, the various activities of a
                  data scientist’s job, and methodology to think and work like a
                  data scientist.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Develop hands-on skills using the tools, languages, and
                  libraries used by professional data scientists.{" "}
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Working with recommender software and systems and Installation
                  and working with analytics tools.{" "}
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Apply various data science skills, techniques, and tools to
                  complete a project and publish a report..{" "}
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
            WHY DATA SCIENCE COURSE IN COIMBATORE?
          </div>
          <div className="text-base text-center pb-4">
            This Data Science course in Coimbatore is designed to give you an
            ability to import and clean data sets. Working with Big Data
            Analytics tools gain you skill to refine and practice more on Data
            Science languages and libraries
          </div>
        </div>
      </div>
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                  Mastering the field of Data science Course starts with
                  understanding and working with the core innovation used for
                  analyzing. You’ll be expertise in complex data science
                  calculations and their execution using Python. Once Master in
                  Data Management and predictive analytic techniques, you will
                  gain exposure to state-of-the-art machine learning
                  technologies. This broad learning way will assist you with
                  dominating over the whole data science technologies and
                  strategies. Icon awesome arrow circle right Train from
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
            WHY KITKAT SOFTWARE ACADEMY FOR DATA SCIENCE COURSE TRAINING IN
            COIMBATORE?
          </div>
          <div className="text-base pb-4 ms-6">
            KITKAT SOFTWARE ACADEMY{" "}
            <span className="font-semibold">Data Science Course</span> training
            in Coimbatore provides extensive hands-on training in Data Science
            tools along with phase-end and capstone projects based on real
            business scenarios
          </div>
          <div className="mt-6">
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
            There are no prerequisites for this Data Science course with
            certification training in Coimbatore. If you are a beginner looking
            to start your career in IT, then this is one of the best courses to
            start with Nschool academy
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto md:px-6 xl:px-24">
          <section>
            ...
            <h2 className="mb-6 pl-6 pr-6 text-2xl font-bold text-white">
              Data Science Course in Coimbatore Highlights
            </h2>
            <div className="mb-6 pl-6 pr-6 text-base text-white">
              Data Science has been gaining popularity for quite some time and
              is currently in high-demand. Data Science is an exciting career
              path for both freshers and experienced individuals
            </div>
