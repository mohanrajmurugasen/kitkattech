...
const items = [
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Installing MongoDB
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  The current SQL/NoSQL landscape
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Document-oriented vs. other types of storage

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Mongo’s feature set
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Common use-cases
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />MongoDB databases
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  MongoDB Collections
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> MongoDB Documents
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Creating documents
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Querying documents
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  find()
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Working with equality
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Query operators
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Building complex queries
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />  Updating documents
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Deleting documents
  ...
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />Word on ORM/ODM
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Installing mongoose
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Connecting to MongoDB from mongoose
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Understanding mongoose schemas and data types
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
            Working with Models
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Using modifiers in schema
          </li>
          <li className="mb-2">
...

  {
    ...
    children: (
      <div>
        <ul>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Validation of model data
          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />{" "}
          ...
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" /> Creating custom instance methods

          </li>
          <li className="mb-2">
            <CheckOutlined className="text-[#49adcc] font-bold mr-2" />CRUD operations with Mongoose
          </li>
        </ul>
      </div>
    ),
...
const items2 = [
  {
    ...
    children: (
      <div>
        ...
        MongoDB is used for transactional tasks to perform well. It is a schema-less operation that the data structures evolve to update the data
  ...
  {
    key: "2",
    label: "What are the benefits of using MongoDB?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
  ...
  {
    key: "3",
    label: "Do you offer a MongoDB course online?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Yes we offer MongoDB courses online. Kindly mail us at contact@n-school.com to know more details about the MongoDB online courses
  ...
  },
  {
    key: "5",
    label:
      "Will I be given sufficient practical training in MongoDB training?",
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        Our course is designed to give a hand-on approach to the students in MongoDB class
  ...
  },
  {
    ...
    children: (
      <div>
        <div className="border-l-4 border-[#49adcc] p-3 text-base pl-3 bg-[#49adcc8f]">
        We do not enforce any prerequisites for learners who want to up skill their knowledge. Everybody is welcome to enroll in this course as the basic programming knowledge is covered here
    ...
    <div>
          ...
          <Row gutter={32} style={{ margin: 0 }} className="items-center">
            <Col lg={12} md={12} sm={24}>
              <div>
                ...
                Get Hands-on knowledge with Real-Time projects from our dedicated MongoDB training courses

                </div>
                <div className="mt-8 mb-12 text-base">
                Power your career with great MongoDB learning and specialize in NoSQL, Data Replication, Indexing and CRUD
      ...
      <div className="section3">
        ...
        <div className="container m-auto p-6">
          ...
          MongoDB Development Training Course
          </div>
          <div className="text-base">Be a part of our
            {" "}
            <span className="font-semibold">MongoDB development training course
              
            </span>{" "}
            in Coimbatore to equip yourselves with the practices and skills required to become an expert. Learn the core and advanced concepts of the NoMySQL database to store, process and analyse big data with increased efficiency.The MongoDB training course offers an in-depth knowledge of Indexing, Data Replication, Sharing, Storage along with the Mongo shell interface. Take the MongoDB course to build a successful career as a MongoDB developer.          </div>
        ...
        <div className="container m-auto p-6">
          ...
          KEY FEATURES OF MongoDB Development COURSE
          </div>
          <div>
            <Row gutter={32} style={{ margin: 0 }}>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  NoSQL database will be taught with clear methodologies to learn more about this open-source database.
              ...
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Understand the complete backup and data restoration with MongoDB.                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                  ...
                  You will be taught the practical ways for data manipulation by using functions and libraries of MongoDB.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  MongoDB Training will be more focused on Database Management and its relevant GUI’s like Robo 3T and Compass.
                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  ...
                  Practical hands-on training will be concentrated more on Schema for efficient data storage and data retrieval                </div>
              </Col>
              <Col lg={12} md={12} sm={24} xs={24} className="mb-4">
                <div className="text-base">
                  <span className="font-semibold">
                  ...
                  You will be taught how MongoDB is incorporated into Cloud Computing technology course.                </div>
              </Col>
            </Row>
          </div>
        </div>
      ...
      <div className="section4 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
          WHY MongoDB Development Course?
          </div>
          <div className="text-base text-center pb-4">
          This MongoDB Development Certification course is designed to give you an essence of front-end, middleware, and back-end web developer technologies. You will learn to build an end-to-end application, test and deploy code, store data using MongoDB, and much more
          </div>
        </div>
      </div>
        ...
        <div className="container m-auto">
          <Row gutter={16} style={{ margin: 0 }} className="items-center">
            ...
            <Col lg={12} md={12} sm={24}>
              <div>
                <div className="text-base">
                Create database solutions for both small-scale to enterprise-level projects by understanding the intricacies and components of MongoDB. NSCHOOL Academy , being a Best MongoDB Development Training Center in Coimbatore always emphasizes on student welfare training programmes in online mode too.
                </div>
                <div className="mt-8">
      ...
      <div className="section7 bg-[#49adcc4a]">
        <div className="container m-auto p-6">
          <div className="text-center text-3xl font-semibold mt-4 mb-8">
          WHY KITKAT SOFTWARE ACADEMY FOR MongoDB development IN COIMBATORE?
          </div>
          <div className="text-base pb-4">
          KITKAT SOFTWARE    Academy’s {" "}
            <span className="font-semibold">MongoDB Development program
            </span>{" "}
            provides extensive hands-on training in front-end, middleware, and back-end technology skills along with phase-end and capstone projects based on real business scenarios          </div>
          <div className="mt-6">
      ...
      <div className="section8 bg-[#49adcc8f]">
        <div className="container m-auto p-6">
          ...
          <div className="text-base text-center pb-4">
          There are no technical requirements to join the MongoDB training course, but basic programming knowledge will be helpful
      ...
      <div className="section9 bg-[#1b424e] pt-8">
        <div className="container mx-auto md:px-6 xl:px-24">
          <section>
            ...
            MongoDB Development Course Highlights</h2>
            <div className="mb-6 pl-6 pr-6 text-base text-white">
            MongoDB web development has been gaining popularity for quite some time and is currently in high-demand. MongoDB development is an exciting career path for both freshers and experienced individuals
